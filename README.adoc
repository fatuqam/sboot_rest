...
[![Build Status](http://localhost:8080/job/Rest_Job/)
...
[![Master Build Status](https://ewe.builds.sb.karmalab.net/buildStatus/icon?job=babelprime-service-master)](https://ewe.builds.sb.karmalab.net/job/babelprime-service-master/)
[![All Build Status](https://ewe.builds.sb.karmalab.net/buildStatus/icon?job=babelprime-service-all)](https://ewe.builds.sb.karmalab.net/job/babelprime-service-all/)
